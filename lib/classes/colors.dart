...
class AppColors {
  static const Color containerBackgroundDarker = Color(0xFF000000);
  ...
  static const Color carColorBlack = Color(0xFF5B5B5B);
  static const Color carColorBlue = Color(0xFF2F95D0);
  static const Color carColorGreen = Color(0xFF39C272);
  static const Color carColorRed = Color(0xFFE86A17);
  static const Color carColorYellow = Color(0xFFFFCC00);
}